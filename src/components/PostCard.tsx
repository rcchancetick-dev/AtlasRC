...
import { ArrowUpRight, Calendar, Download, Eye, FileText, Image, Music, Video } from 'lucide-react';
...
const dateHeure = (iso: string) => `${new Date(iso).toLocaleDateString('fr-FR')} à ${new Date(iso).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}`;
